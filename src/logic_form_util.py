...
reverse_properties = {}
# with open(path + '/../data/FB_ontology/reverse_properties', 'r') as f:
#     for line in f:
#         reverse_properties[line.split('\t')[0]] = line.split('\t')[1].replace('\n', '')
reverse_properties = load_json("/home5/yhbao/SPARQLannotation/data/FB_ontology/full_reverse_properties.json")

with open(path + '/../data/FB_ontology/fb_roles', 'r') as f:
    content = f.readlines()
...
with open(path + '/../data/FB_ontology/fb_types', 'r') as f:
    content = f.readlines()
