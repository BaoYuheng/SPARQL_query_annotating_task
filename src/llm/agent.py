...
#记得注释掉，被偷钱的
openai_api_keys = ["YOURS"]

openai_base_uri = "YOURS"

class OpenAiRequestor():
    def __init__(self, model, api_keys=openai_api_keys, url=openai_base_uri, logger=None, timeout=60, max_retries = 3) -> None:
    ...
    def concurrent_query(self, messages, n_threads, intent:QueryIntent):
        ...
        for i in range(0, n_threads):
            ...
            future = pool.submit(self.sequence_query, message_split, intent, self.api_keys[i % len(self.api_keys)])
