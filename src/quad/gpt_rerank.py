from src.llm_agent import OpenAiRequestor, QueryIntent
from src.common import KB_TYPE, DATASET
...
def get_top1_sparql_by_gpt(search_result_file, data_file, output_dir, dataset:DATASET, model):
    ...
    gpt_asker = OpenAiRequestor(model, url='https://api.gpt.ge/v1/')
