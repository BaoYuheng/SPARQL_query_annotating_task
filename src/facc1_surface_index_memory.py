...
class EntitySurfaceIndexMemory(object):
    ...
    def instance(cls, *args, **kwargs):
        if not hasattr(EntitySurfaceIndexMemory, "_instance"):
            EntitySurfaceIndexMemory._instance = EntitySurfaceIndexMemory(*args, **kwargs)
        return EntitySurfaceIndexMemory._instance
